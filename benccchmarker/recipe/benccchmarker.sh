mamba create -n benccchmarker -c conda-forge -c bioconda -c defaults python=3.10 r-base=4.3.1 r-devtools r-biocmanager r-ggplot2 r-seurat cmake rpy2 r-peakram r-anndata r-ggplot2 r-nmf r-presto r-rspectra r-magick -y
...
# Install CiteFuse
Rscript -e "BiocManager::install('CiteFuse')"
